...
import explainController from "../controllers/explain.controller.js";
...
router.get(
  "/prediction",
  tokenMiddleware.auth,
  predictionController.getPredictionsOfUser
);

router.get(
  "/explain",
  tokenMiddleware.auth,
  explainController.getExplainOfUser
);
